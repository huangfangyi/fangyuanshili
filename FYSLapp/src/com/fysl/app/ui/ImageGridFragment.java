...
import com.fysl.app.BuildConfig;
import com.fysl.app.R;
import com.fysl.app.domain.VideoEntity;
import com.fysl.app.video.util.ImageCache;
import com.fysl.app.video.util.ImageResizer;
import com.fysl.app.video.util.Utils;
import com.fysl.app.widget.RecyclingImageView;
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if (position == 0) {
				...
				holder.imageView
						.setImageResource(R.drawable.em_actionbar_camera_icon);
			} else {

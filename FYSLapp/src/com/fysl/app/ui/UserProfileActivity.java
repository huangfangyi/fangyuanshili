...
public class UserProfileActivity extends BaseActivity implements
	...
	public void onClick(View v) {
		...
		case R.id.rl_nickname:
			...
			new AlertDialog.Builder(this)
					...
					.setView(editText)
					.setPositiveButton(R.string.dl_ok,
							new DialogInterface.OnClickListener() {

								@Override
								public void onClick(DialogInterface dialog,
										int which) {
									String nickString = editText.getText()
											.toString();
					...
					public void onSuccess(EaseUser user) {
						if (user != null) {
							...
							if (!TextUtils.isEmpty(user.getAvatar())) {
								...
								Glide.with(UserProfileActivity.this)
										.load(R.drawable.em_default_avatar)
										.into(headAvatar);
							}
						}
					}
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							Toast.makeText(UserProfileActivity.this,
									getString(R.string.toast_no_support),
									Toast.LENGTH_SHORT).show();
							break;
						case 1:
	...
	private void updateRemoteNick(final String nickName) {
		dialog = ProgressDialog.show(this, getString(R.string.dl_update_nick),
				getString(R.string.dl_waiting));
	...
	private void uploadUserAvatar(final byte[] data) {
		dialog = ProgressDialog.show(this, getString(R.string.dl_update_photo),
				getString(R.string.dl_waiting));
		new Thread(new Runnable() {
